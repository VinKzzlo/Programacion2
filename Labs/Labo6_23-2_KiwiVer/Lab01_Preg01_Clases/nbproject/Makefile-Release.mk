...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab01_preg01_clases.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab01_preg01_clases.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lab01_preg01_clases ${OBJECTFILES} ${LDLIBSOPTIONS}
